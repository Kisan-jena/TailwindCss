const Hero = () => {
  return (
    <div className="bg-red-00 flex w-full flex-col items-center justify-center py-45">
      ...
      <div className="mt-8 flex w-full max-w-lg justify-center bg-amber-00">
        <input
          type="text"
          className="mr-4 flex-1 rounded-xl border border-neutral-600 px-4 text-neutral-300 placeholder:text-neutral-500 focus:ring-1 focus:ring-sky-400 focus:outline-none transition duration-200"
